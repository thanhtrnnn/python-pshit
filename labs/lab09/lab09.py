...
class Rhombus(Parallelogram):
    ...
    def setSide(self, value):
        assert value.isnumeric(), 'not valid value'
        assert value >= 0, 'not valid value'
        self._l1 = value
    ...
    def __init__(self, x, y, side, d):
        ...
        assert type (side)==int or type (side)==float
...
class Rectangle(Parallelogram):
    ...
    def __init__(self, x, y, w, h):
        ...
        set the fill color to introcs.WHITE by default.
    ...
    def getArea(self):
        ...
        # IMPLEMENT ME
        return str(self.getL1()*self.getL2())
    ...
    def __str__(self):
        ...
        return 'rectangle at ' + Shape.__str__(self) + 'dimension'+ str(self.getL1()) +str(self.getL2())+',area'+self.getArea()
...
def draw_shapes(panel):
    ...
    # CHANGE THIS TO MAKE FILL COLOR RGB(255, 255, 0)
    s5 = Rectangle(x-h+(2*h), y-vert1-20,60, 20)
    s5.setColor(introcs.RGB(0, 255, 0))
    s5.setFill(introcs.RGB(255, 255, 0))
    panel.draw(s5)
    print(str(s5))

    s5 = Rectangle(x-h-60, y-vert1-20, 60, 20)
    s5.setColor(introcs.RGB(0, 255, 0))
    s5.setFill(introcs.RGB(255, 255, 0))
    panel.draw(s5)
    print(str(s5))

    s5 = Rectangle(x-h, y-vert1-60, 60, 60)
    s5.setColor(introcs.RGB(0, 255, 0))
    s5.setFill(introcs.RGB(255, 255, 0))
    panel.draw(s5)
    print(str(s5))
    ...
    # OPTIONAL HAT
    s8 = Rhombus(x-h, y+vert1, h, -d2)
    s8.setColor(introcs.RGB(0, 0, 255))
    panel.draw(s8)
    print(str(s8))

    s8 = Rhombus(x-10, y+vert1, h, d2)
    s8.setColor(introcs.RGB(0, 0, 255))
    panel.draw(s8)
    print(str(s8))
    # END HAT
